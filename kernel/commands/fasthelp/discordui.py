        ...
        for commandPath in commandPaths:
            try:
                ...
                for directory in dirList:
                    if os.path.isdir(os.path.join(commandPath, directory)) and os.path.exists(os.path.join(commandPath, directory, "discordui.py")):
                        with open(os.path.join(commandPath, directory, "discordui.py"), 'r') as f:
                            content = f.read()
