    ...
    try:
        ...
        async def on_message(message_original):
            ...
            try:
                ...
                if Registry.read("SOFTWARE.CordOS.Experimental.SystemEventHooker.InboundPassive",
                                 default="0") == "1":
                ...
                if Registry.read("SOFTWARE.CordOS.Experimental.SystemEventHooker.InboundInteractive", default="0") == "1":
                    ...
                    try:
                        ...
                        if Registry.read("SOFTWARE.CordOS.Kernel.PrintErrors") == "1": print(
                ...
                if message.content.startswith("."):
                    if message.content == ".regrestore":
                        ...
                        print(
                            "Terminating system and restarting kernel in safemode. Set `SOFTWARE.CordOS.Kernel.SafeMode` to 0 after reboot to return to normal mode.")
                        await message.reply(
                            "Terminating system and restarting kernel in safemode. Set `SOFTWARE.CordOS.Kernel.SafeMode` to 0 after reboot to return to normal mode.",
                            mention_author=True)
                        try:
                            ...
                            print(
                                "Failed to update registry / IPC. The system will try reboot to safe mode anyway.")
                            await message.reply(
                                "Failed to update registry. The system will try reboot to safe mode anyway.",
                                mention_author=True)
                            sys.exit(3)
